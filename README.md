...
- 🇨🇱 **Chile — *Jubaea chilensis* (Palma chilena):** cruce de idoneidad climática con **MapBiomas Chile Colección 2 (2024)**, postulado al Premio MapBiomas Chile 2026 (1.ª Edición). El 77% del hábitat de alta idoneidad climática persiste como vegetación natural o restaurable, pero solo el 12,6% de ese hábitat está dentro de un área protegida (WDPA/SNASPE). Incluye un anexo de sensibilidad metodológica comparando Colección 1 y 2. Ver [`extensiones/chile/`](./extensiones/chile/).
