...
- 🇨🇱 **Chile — *Jubaea chilensis* (Palma chilena):** integra tres productos de MapBiomas Chile (cobertura Colección 2, áreas protegidas WDPA/SNASPE y Producto Fuego), postulado al Premio MapBiomas Chile 2026 (1.ª Edición). El 77% del hábitat de alta idoneidad climática persiste como vegetación natural o restaurable, solo el 12,6% está protegido, y un palmar protegido específico ("Palmar El Salto") perdió el 80% de su hábitat al fuego entre 2013-2025. Un ranking de los 6 palmares identifica a Cocalán y Petorca como máxima prioridad de conservación. Ver [`extensiones/chile/`](./extensiones/chile/).
